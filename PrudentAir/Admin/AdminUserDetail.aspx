<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master_Page.Master" CodeBehind="AdminUserDetail.aspx.cs" Inherits="PrudentAir.Admin.AllUserDetail" %>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td bgcolor="#FFFFFF">
                                        ...
                                        <asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/admin/RevenueByCriteria.aspx"
...
<center>
<asp:TextBox ID="txtSeachUserName" runat="server" style="text-align: left" 
        Height="16px"></asp:TextBox>
    <asp:ImageButton ID="ImageButton1" runat="server" BorderColor="Maroon" 
        BorderStyle="Solid" Height="16px" ImageUrl="~/images/search.gif" 
        onclick="ImageButton1_Click" Width="16px" ToolTip="Search By UserName" />
    </center>
        ...
        <ContentTemplate>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns=false 
              ...
              <Columns>
               ...
               <asp:TemplateField HeaderText="IsAnonymous">
                <ItemTemplate>
                     <asp:Label ID="lblIsAnonymous" runat="server" Text='<%#Eval("IsAnonymous") %>'></asp:Label>
                </ItemTemplate>
              </asp:TemplateField>
